...
allTypes = ['apc', 'ycb',  'concaveArea']
good = ['006_mustard_bottle', '072-b_toy_airplane', '007_tuna_fish_can', '035_power_drill', '044_flat_screwdriver']
for datatype in allTypes:
    ...
    for subDir in os.listdir(sourceF):
        if subDir in recordList:
            ...
            #         print(subDir)
            #         print(subPath)
            #         targetPath = os.path.join('../../picture/BlenderToolbox/meshes/packing/vhacd_parts', datatype, subDir)
            #         copytree(subPath, targetPath)
